...
fn = '/corral/utexas/hurricane/tgower/ida_dataset_02/Pot_Temp_HIDA_d02.nc'
...
#adding the long lat grids and enabling the tick labels
 ...
 # adding colorbar and adjust the size
    ...
    cbar.set_label('Kelvin (K)', rotation = -90, labelpad = 12)
    cbar.minorticks_on()
...
#Save figure and clear previous
    plt.savefig("/corral/utexas/hurricane/tgower/TempCorrelation/Plots/Plot_IDA_02/Temp_plots/Temp_hr" + str((i*15)/60) + ".jpg",dpi=330)
    plt.clf()
#close dataset
dataset.close()
